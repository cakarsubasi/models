...
#$TRANSCRIPT_PATH="C:/Users/explo/Documents/Repositories/models/models/model-new/transcripts/resnet152.txt"
$TRANSCRIPT_PATH="C:/Users/explo/Documents/Repositories/models/models/model-new/transcripts/efficientdet_d1_train.txt"
